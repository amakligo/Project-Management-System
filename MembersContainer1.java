 ...
 * @author Mawutor
 */
class MembersContainer1 extends Container
{
    ...
    public MembersContainer1(String memberID,String memberName,String  memberFN,String projectID) {
        super(new BoxLayout(BoxLayout.Y_AXIS));
        this.projectID = projectID;
        this.memberID = memberID;
        this.memberName = memberName;
        this.memeberFN = memberFN;
        button = new Button("Assign as Team Member");
        button.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent evt) {
                WebServiceProxy.addManagerAsync(getMemberID(),getProjectID(), "Team Member ", new Callback() {
                    @Override
