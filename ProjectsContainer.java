...
class ProjectsContainer extends Container {
    ...
    public void fillListOfsomeTeamMembers(ArrayList arraylist) {
        Form form = new Form("CHOOSE PROJECT MANAGER", new BoxLayout(BoxLayout.Y_AXIS));
        button1 = new Button("Back");

        for (Object project : arraylist) {
            Object[] memeber = (Object[]) project;
            MembersContainer membersContainer = new MembersContainer(memeber[0].toString(), memeber[1].toString(), memeber[2].toString(), getProjectID());
    ...
    public ProjectsContainer(String projectID,String projectName) {
        super(new BoxLayout(BoxLayout.Y_AXIS));
        this.projectID =  projectName;
        this.projectName =projectID;
        button = new Button("Assign Project Manager");
